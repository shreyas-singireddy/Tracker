...
from app.models.habit_recovery import SleepLog, RecoveryLog
    ...
    with tab_today:
        ...
        with col_stats:
            ...
            if rec_log:
                ...
                st.info("No recovery readiness score has been computed for this date yet. Log sleep on the right to calculate.")
        ...
        with col_form:
            ...
            with st.form(key="sleep_log_form"):
                ...
                if submit_sleep:
                    try:
                        ...
                        if existing_slp:
                            recovery_service.sleep_repo.delete(
                                "sleep_logs", "sleep_log_id", existing_slp.sleep_log_id
                            )
            ...
            with st.form(key="baseline_form"):
                baseline_h = st.number_input("Sleep Goal Target (hours)", min_value=4.0, max_value=12.0, value=current_baseline, step=0.5)
    ...
    with tab_trends:
        ...
        try:
            ...
            df_history = pd.DataFrame({
                "Date": dates,
                "Recovery Score (%)": recovery_history,
                "Sleep Duration (hrs)": sleep_history
            })
