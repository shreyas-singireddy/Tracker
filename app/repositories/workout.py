from app.models.workout import ExerciseLog, ExerciseSet, WorkoutPlan, WorkoutSession
...
class WorkoutPlanRepository(BaseRepository):
    ...
    def get_plan(self, plan_id: str) -> WorkoutPlan | None:
...
class WorkoutSessionRepository(BaseRepository):
    ...
    def get_active_session(self, user_id: str) -> WorkoutSession | None:
...
class ExerciseLogRepository(BaseRepository):
    ...
    def get_log(self, exercise_log_id: str) -> ExerciseLog | None:
    ...
    def get_log_by_session_and_exercise(self, session_id: str, exercise_id: str) -> ExerciseLog | None:
...
class ExerciseSetRepository(BaseRepository):
    ...
    def get_set(self, set_id: str) -> ExerciseSet | None:
    ...
    def get_duplicate_set(self, exercise_log_id: str, set_number: int) -> ExerciseSet | None:
