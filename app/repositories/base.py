...
class BaseRepository:
    ...
    def _filter_fields_by_schema(self, table: str, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"Failed to query table info for column filtering on table {table}: {e!s}")
            return data
    ...
    def create(self, table: str, data: dict[str, Any]) -> Any:
        ...
        try:
            ...
            logger.error(f"Failed to create record in {table}: {e!s}")
            raise RepositoryError(f"Failed to create record in {table}", details=str(e))

    def read(self, table: str, id_column: str, id_value: Any) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.error(f"Failed to read record from {table}: {e!s}")
    ...
    def update(self, table: str, id_column: str, id_value: Any, data: dict[str, Any]) -> int:
        ...
        try:
            ...
            logger.error(f"Failed to update record in {table}: {e!s}")
    ...
    def delete(self, table: str, id_column: str, id_value: Any) -> int:
        ...
        try:
            ...
            logger.error(f"Failed to delete record from {table}: {e!s}")
    ...
    def list_all(self, table: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Failed to list records from {table}: {e!s}")
