...
class HabitModule(BaseModule):
    ...
    def init(self) -> None:
        ...
        self.service = HabitService(habit_repo=self.habit_repo, habit_log_repo=self.habit_log_repo)

    def get_services(self) -> dict[str, Any]:
        return {"HabitService": self.service}

    def get_repositories(self) -> dict[str, Any]:
        return {"HabitRepository": self.habit_repo, "HabitLogRepository": self.habit_log_repo}
    ...
    def health_check(self) -> dict[str, Any]:
        try:
            ...
            return {"status": "RED", "details": f"Habit health check failed: {e!s}"}
