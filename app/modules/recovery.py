...
class RecoveryModule(BaseModule):
    ...
    def init(self) -> None:
        ...
        self.service = RecoveryService(
            sleep_repo=self.sleep_repo, recovery_repo=self.recovery_repo, profile_repo=self.profile_repo
        )
    ...
    def health_check(self) -> dict[str, Any]:
        try:
            ...
            return {"status": "RED", "details": f"Recovery health check failed: {e!s}"}
