...
class DatabaseManager:
    ...
    def transaction(self):
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Transaction rollback failed: {str(rollback_err)}")
            logger.error(f"Transaction failed, changes rolled back: {str(e)}")
    ...
    def execute_write(self, query: str, params: tuple = ()) -> int:
        ...
        with self.transaction() as conn:
            try:
                ...
                logger.error(f"Database write execution failed: {str(e)}\nQuery: {query}")
    ...
    def execute_read(self, query: str, params: tuple = ()) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Database read execution failed: {str(e)}\nQuery: {query}")
            raise DatabaseError("Failed to read from database", details=str(e))

    def execute_read_one(self, query: str, params: tuple = ()) -> Optional[Dict[str, Any]]:
